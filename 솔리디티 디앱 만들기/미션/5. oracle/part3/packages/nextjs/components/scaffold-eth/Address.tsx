...
export const Address = ({ address, disableAddressLink, format, size = "base" }: AddressProps) => {
  ...
  try {
    // address 값이 객체인 경우 address 속성을 사용하도록 수정
    const addressString = typeof address === "object" && address.address ? address.address : address;

    // address가 유효한 문자열인지 확인
    checkSumAddress = addressString ? getAddress(addressString) : undefined;
  } catch (error) {
